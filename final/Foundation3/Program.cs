...
class Program
{
    static void Main(string[] args)
    {
        ...
        addresses[1] = new Address("Las Tapias avenue, 3rd Street", "Merida", "Merida", "5115", "Venezuela");
        addresses[2] = new Address("75 Battery Place", "New York City", "New York", "10280", "United States");
        Event[] events =  new Event[3];
        events[0] = new LectureEvent("C# Programming Speach","Get new programming knowledge with this new opening speech to C# programming language","02/10/2023","08:00pm",addresses[0],"Amelia","50 People");
        events[1] = new ReceptionEvent("Antonio's Wedding","Come here to celebrate Antonio's wedding","06/02/2023","03:30pm",addresses[1],"antonio@gmail.com");
